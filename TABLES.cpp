...
struct info_assemdir 
{
    string assembler_dir;
    char exist;
    info_assemdir()
    {
        exist = 'n';
...
typedef std::map<mnemonic, info_assemdir>   MapType5;
...
// This maps the assembler directive statements to their existence.
MapType5 ASSEMDIR;
...
/*--------------------------*/
ASSEMDIR["START"].exist = 'y';
ASSEMDIR["END"].exist = 'y';
ASSEMDIR["BYTE"].exist = 'y';
ASSEMDIR["WORD"].exist = 'y';
ASSEMDIR["RESB"].exist = 'y';
ASSEMDIR["RESW"].exist = 'y';
ASSEMDIR["BASE"].exist = 'y';
ASSEMDIR["NOBASE"].exist = 'y';
}
